...
public:
    ...
    virtual size_t getMemoryUsage(bool includeSecAttrs = false) {};
    virtual Timestamp getEarliestTimestamp() { return 0; };
...
//    virtual void removeEmptyBuffers() {};
    ...
    // Sampling support  
    virtual void execute_pureTimeTravel_candidates(RangeQuery Q, vector<DIT::DIT_CandidateLog> &candidates) { };
    virtual void execute_pureTimeTravel_candidates(RangeQuery Q, vector<AugmentedIntervalTree::AIT_CandidateLog> &candidates) { };
    virtual void execute_pureTimeTravel(RangeQuery Q, vector<RecordId> &candidates) { };
};
...
public:
    ...
    size_t getMemoryUsage(bool includeSecAttrs);
    Timestamp getEarliestTimestamp();
...
//    void removeEmptyBuffers();
    ...
    // Sampling support
    void execute_pureTimeTravel_candidates(RangeQuery Q, vector<DIT::DIT_CandidateLog> &candidates);
    void execute_pureTimeTravel_candidates(RangeQuery Q, vector<AugmentedIntervalTree::AIT_CandidateLog> &candidates);
